...
### Packages/Projects
- [``svi-py``](https://github.com/marwinsteiner/pysvi) [![PyPI Downloads](https://static.pepy.tech/personalized-badge/svi-py?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/svi-py) Building volatility surfaces using the stochastic-volatility inspired family of IV parametrisations.
- [``pymgarch``](https://github.com/marwinsteiner/pymgarch) [![PyPI Downloads](https://static.pepy.tech/personalized-badge/pymgarch?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/pymgarch) Multivariate GARCH for Python by porting tsmgarch (R package) to Python and extending it.
- [``polygon-options-puller``](https://github.com/marwinsteiner/polygon-options-puller) [![PyPI Downloads](https://static.pepy.tech/personalized-badge/polygon-options-puller?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/polygon-options-puller) Pull, reformat, and store Massive/Polygon S3 flat files.
- [``interest-rate-models``](https://github.com/marwinsteiner/interest-rate-models) [![PyPI Downloads](https://static.pepy.tech/personalized-badge/interest-rate-models?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/interest-rate-models) Access different interest rate models: short-rate models (Vasicek, CIR, Ho-Lee, Hull-White, G2++) and full-curve models (Heath-Jarrow-Morton, LIBOR Market Model) behind one interface
